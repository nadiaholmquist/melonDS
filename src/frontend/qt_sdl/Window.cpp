    ...
    if (hasMenu)
    {
        QMenuBar * menubar = new QMenuBar();
        {
...

            {
                ...
                int addons[] = {GBAAddon_RAMExpansion, GBAAddon_RumblePak, GBAAddon_SolarSensorBoktai1, GBAAddon_SolarSensorBoktai2, GBAAddon_SolarSensorBoktai3, GBAAddon_Analog, -1};
